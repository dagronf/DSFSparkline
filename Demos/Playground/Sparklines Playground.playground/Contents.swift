...
do {
	...
	h1.fill = DSFSparkline.Fill(flatColor: NSColor.gray.withAlphaComponent(0.2).cgColor)
...
do {
	...
	h2.fill = DSFSparkline.Fill(flatColor: NSColor.systemRed.withAlphaComponent(0.1).cgColor)
...
do {
	...
	stack.primaryFill = DSFSparkline.Fill(flatColor: NSColor.systemPurple.withAlphaComponent(0.7).cgColor)
	stack.secondaryStrokeColor = NSColor.systemPink.cgColor
	stack.secondaryFill = DSFSparkline.Fill(flatColor: NSColor.systemPink.withAlphaComponent(0.7).cgColor)
